...
ActiveRecord::Schema.define(version: 2020_01_02_215834) do
  ...
  create_table "collection_artworks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["artwork_id", "collection_id"], name: "index_collection_artworks_on_artwork_id_and_collection_id", unique: true
